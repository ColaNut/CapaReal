...
clc; clear;
tmprtrName = '20180811_case_unaffected';
fname = 'e:\Kevin';
% fname = 'd:\Kevin\CapaReal\';
% CaseName = 'Power250';
load( strcat(fname, '\20180811_case_unaffected.mat') );
...
pre_bar_d = bar_d;
fname = 'e:\Kevin';
load( strcat(fname, '\20180811_case_unaffected.mat'), 'Q_s_Vector', 'W' );
...
fname = 'e:\Kevin\CapaReal\20180811_case_unaffected';
save( strcat(fname, '\20180811_case_unaffected_TmprtrTimePlot.mat') );
