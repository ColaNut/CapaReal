function B_k_Pnt = fillBk_FW( vIdx1, vIdx2, vIdx3, vIdx4, v1Table, v2Table, v3Table, v4Table, ...
                    B_k_Pnt, PntJ_xyz, x_max_vertex, y_max_vertex, z_max_vertex, Vertex_Crdnt, varargin )
