function PntsIdx = get27Pnts_KEV( m_v, n_v, ell_v, x_max_vertex, y_max_vertex, z_max_vertex, Vertex_Crdnt )

    PntsIdx     = zeros( 3, 9 );
    % PntsCrdnt   = zeros( 3, 9, 3 );
    % PntsMed     = zeros( 3, 9 );

    PntsIdx( 1, 1 ) = get_vIdx( m_v - 1, n_v - 1, ell_v - 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 1, 2 ) = get_vIdx( m_v    , n_v - 1, ell_v - 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 1, 3 ) = get_vIdx( m_v + 1, n_v - 1, ell_v - 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 1, 4 ) = get_vIdx( m_v - 1, n_v    , ell_v - 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 1, 5 ) = get_vIdx( m_v    , n_v    , ell_v - 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 1, 6 ) = get_vIdx( m_v + 1, n_v    , ell_v - 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 1, 7 ) = get_vIdx( m_v - 1, n_v + 1, ell_v - 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 1, 8 ) = get_vIdx( m_v    , n_v + 1, ell_v - 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 1, 9 ) = get_vIdx( m_v + 1, n_v + 1, ell_v - 1, x_max_vertex, y_max_vertex, z_max_vertex );

    PntsIdx( 2, 1 ) = get_vIdx( m_v - 1, n_v - 1, ell_v    , x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 2, 2 ) = get_vIdx( m_v    , n_v - 1, ell_v    , x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 2, 3 ) = get_vIdx( m_v + 1, n_v - 1, ell_v    , x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 2, 4 ) = get_vIdx( m_v - 1, n_v    , ell_v    , x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 2, 5 ) = get_vIdx( m_v    , n_v    , ell_v    , x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 2, 6 ) = get_vIdx( m_v + 1, n_v    , ell_v    , x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 2, 7 ) = get_vIdx( m_v - 1, n_v + 1, ell_v    , x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 2, 8 ) = get_vIdx( m_v    , n_v + 1, ell_v    , x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 2, 9 ) = get_vIdx( m_v + 1, n_v + 1, ell_v    , x_max_vertex, y_max_vertex, z_max_vertex );

    PntsIdx( 3, 1 ) = get_vIdx( m_v - 1, n_v - 1, ell_v + 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 3, 2 ) = get_vIdx( m_v    , n_v - 1, ell_v + 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 3, 3 ) = get_vIdx( m_v + 1, n_v - 1, ell_v + 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 3, 4 ) = get_vIdx( m_v - 1, n_v    , ell_v + 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 3, 5 ) = get_vIdx( m_v    , n_v    , ell_v + 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 3, 6 ) = get_vIdx( m_v + 1, n_v    , ell_v + 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 3, 7 ) = get_vIdx( m_v - 1, n_v + 1, ell_v + 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 3, 8 ) = get_vIdx( m_v    , n_v + 1, ell_v + 1, x_max_vertex, y_max_vertex, z_max_vertex );
    PntsIdx( 3, 9 ) = get_vIdx( m_v + 1, n_v + 1, ell_v + 1, x_max_vertex, y_max_vertex, z_max_vertex );
