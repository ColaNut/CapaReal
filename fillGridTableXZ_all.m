...
[ tmp_x_grid_table{4}, tmp_z_grid_table{4} ] = fillGridTable( l_lung_x, l_lung_z, l_lung_a, l_lung_b, dx, dz );
[ tmp_x_grid_table{5}, tmp_z_grid_table{5} ] = fillGridTable( r_lung_x, r_lung_z, r_lung_a, r_lung_b, dx, dz );
