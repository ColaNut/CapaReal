...
load('0824preK1_liver.mat');
              ...
              % [ air, bolus, muscle, lung,   tumor,  bone,   fat ]';
mu_prime      = [   1,     1,      1,     1,      1,     1,     1 ]';
mu_db_prime   = [   0,     0,      0,     0, 0.3759,     0,     0 ]';
% mu_db_prime   = [ 0,    0.62 ]';
mu_r          = mu_prime - i * mu_db_prime;
...
save('0824MQS_postK1_noFatAndBone_MuPrmPrmMod.mat', 'm_K1');
...
for PartNum = 1: 1: 6
    % this is for liver
    load(strcat('f:\CapaReal\0824MQS_postK1', num2str(PartNum), '_noFatAndBone.mat'), 'B_k', 'm_K1');
