function [ PntSARseg, TtrVol, MidPnts9Crdnt, Pnt_absE ] = calSARsegYZ( m, n, ell, PhiYZ, ThrXYZCrndt, SegValueYZ, ...
                                                        y_idx_max, sigma, rho )
    ...
    MidPhi       = zeros( 3, 9 );
    tmpMidPhi    = zeros( 9 );
    PntSegValue  = squeeze( SegValueYZ( n, ell, :, : ) );

    [ PntsIdx, PntsCrdnt ] = get27Pnts( m, n, ell, 3, y_idx_max, ThrXYZCrndt );
    ...
    MidPhi       = cal27MidPhi( m, n, ell, PhiYZ );
