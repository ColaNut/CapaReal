function SheetPnts = getSheetPnts(m, n, ell, x_idx_max, y_idx_max, shiftedCoordinateXYZ, mediumTable, SheetPnts)
    ...
    if CoordinateXZ(m, ell, 1) <= 0 && CoordinateXZ(m, ell, 2) >= 0 
        SheetPntsXZ = UpdtSheetPnts(SheetPntsXZ, firstMed + 4);
    ...
    elseif CoordinateXZ(m, ell, 1) >= 0 && CoordinateXZ(m, ell, 2) >= 0 
        SheetPntsXZ = UpdtSheetPnts(SheetPntsXZ, firstMed + 2);
        SheetPnts(1, :, 2) = SheetPntsXZ(4);
        SheetPnts(2, :, 2) = SheetPntsXZ(5);
    ...
    elseif CoordinateXZ(m, ell, 1) <= 0 && CoordinateXZ(m, ell, 2) <= 0 
        ...
        SheetPntsXZ = UpdtSheetPnts(SheetPntsXZ, tmpIdx);
        SheetPnts(2, :, 1) = SheetPntsXZ(2);
