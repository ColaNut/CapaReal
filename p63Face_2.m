...
switch Text
    case 'Crdnt'
        ...
        Extract5(1, 2, :) = Ori27(2, 2, :);
        Extract5(1, 3, :) = Ori27(1, 2, :);
        Extract5(1, 4, :) = Ori27(1, 5, :);
        Extract5(1, 5, :) = Ori27(1, 3, :);
    case 'Med'
        Extract5 = zeros(5, 1);
        Extract5(1) = Ori27(1, 1);
        Extract5(2) = Ori27(2, 2);
        Extract5(3) = Ori27(1, 2);
        Extract5(4) = Ori27(1, 5);
        Extract5(5) = Ori27(1, 3);
    otherwise
        error('check');
end
