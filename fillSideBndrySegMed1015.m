function SegMed = fillSideBndrySegMed1015( SegMed, Side9Pnts, CtrlPnt, SidePntFlag, CtrlPntFlag, varargin )
...
% SegMed      = ones(1, 8, 'uint8');
    ...
    for idx = 1: 1: 8
        SegMed(idx) = getTetMed1015( SegMed(idx), TtrCrdnt(idx, :), CtrlPntFlag, varargin{:} );
    end
