function [ K1_Value, J ] = CurrentType2( SideCrdnt, CntrlCrdnt, Side_Cflag, Cntrl_Cflag, SegMed, J_0, mu_r, SideIdx )
% Cflag -> current flag
...
switch SideIdx
    ...
    case '2'
        ...
        [ FourTet_e(4, :, :), J ] = calBC( SideCrdnt(4, :), CntrlCrdnt', SideCrdnt(3, :), SideCrdnt(1, :), ...
                                Side_Cflag(4), Cntrl_Cflag, Side_Cflag(3), Side_Cflag(1), 1, 'inn', J_0, J, mu_r(SegMed(4)) );
    ...
    case '4'
        ...
        % FourTet_e(1, :, :) = calBC( SideCrdnt(4, :), SideCrdnt(5, :), SideCrdnt(3, :), CntrlCrdnt', ...
        ...
        % FourTet_e(4, :, :) = calBC( SideCrdnt(4, :), SideCrdnt(3, :), SideCrdnt(1, :), CntrlCrdnt', ...
    ...
    case '5'
        ...
        % FourTet_e(4, :, :) = calBC( SideCrdnt(3, :), SideCrdnt(4, :), CntrlCrdnt', SideCrdnt(1, :), ...
    ...
    case '7'
        ...
        % K_1: the 1-st to the 8-th tetdrahedron
        SixTet_e(1, :, :) = calBC( SideCrdnt(7, :), SideCrdnt(4, :), SideCrdnt(3, :), CntrlCrdnt', ...
                                Side_Cflag(7), Side_Cflag(4), Side_Cflag(3), Cntrl_Cflag, 6, 'ext', J_0 );
        SixTet_e(2, :, :) = calBC( SideCrdnt(7, :), SideCrdnt(6, :), SideCrdnt(3, :), CntrlCrdnt', ...
                                Side_Cflag(7), Side_Cflag(6), Side_Cflag(3), Cntrl_Cflag, 6, 'inn', J_0 );
        SixTet_e(3, :, :) = calBC( SideCrdnt(6, :), SideCrdnt(3, :), CntrlCrdnt', SideCrdnt(5, :), ...
                                Side_Cflag(6), Side_Cflag(3), Cntrl_Cflag, Side_Cflag(5), 4, 'inn', J_0 );
        SixTet_e(4, :, :) = calBC( SideCrdnt(3, :), CntrlCrdnt', SideCrdnt(5, :), SideCrdnt(2, :), ...
                                Side_Cflag(3), Cntrl_Cflag, Side_Cflag(5), Side_Cflag(2), 1, 'inn', J_0 );
        SixTet_e(5, :, :) = calBC( SideCrdnt(3, :), CntrlCrdnt', SideCrdnt(1, :), SideCrdnt(2, :), ...
                                Side_Cflag(3), Cntrl_Cflag, Side_Cflag(1), Side_Cflag(2), 1, 'ext', J_0 );
        SixTet_e(6, :, :) = calBC( SideCrdnt(4, :), SideCrdnt(3, :), CntrlCrdnt', SideCrdnt(1, :), ...
