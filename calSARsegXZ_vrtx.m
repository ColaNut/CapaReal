function [ PntSARseg, TtrVol, MidPnts9Crdnt ] = calSARsegXZ_vrtx( m_B, n_B, ell_B, PhiXZ, x_max_vertex_B, y_max_vertex_B, Vertex_Crdnt_B, PntSegMed_B, sigma, rho )
    ...
    MidPhi = get27Phi( m_v_B, 2, ell_v_B, PhiXZ );
