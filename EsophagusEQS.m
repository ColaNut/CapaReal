...
% % mediumTable_Esphgs(26, :, 27) = EsBndryNum;
% % mediumTable_Esphgs(25, :, 26) = EsBndryNum;
% % mediumTable_Esphgs(26, :, 25) = EsBndryNum;
% % mediumTable_Esphgs(27, :, 26) = EsBndryNum;
% % mediumTable_Esphgs(26, :, 26) = 1;
...
% % %                         dx, dy, dz, air_x, air_z, h_torso, x_max_vertex, y_max_vertex, z_max_vertex, BndryTable, TpElctrdPos );
% % mediumTable_DwnElctrd = zeros(x_idx_max, z_idx_max);
% % % a script
% % mediumTable_DwnElctrd(x_es_n - 1, z_es_n) = 1;
% % mediumTable_DwnElctrd(x_es_n    , z_es_n) = 1;
% % mediumTable_DwnElctrd(x_es_n + 1, z_es_n) = 1;
% % sparseS = PutOnDwnElctrd_Esophagus0920( sparseS, mediumTable_DwnElctrd, x_max_vertex, y_max_vertex );
