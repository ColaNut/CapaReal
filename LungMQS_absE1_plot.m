...
load('D:\Kevin\GraduateSchool\Projects\ProjectBio\Simlation\CapaReal\0823LungMQS\0823_100kHz.mat');
...
saveas(figure(8), fullfile(fname, strcat(CaseName, 'E1_XZ_MQS')), 'jpg');
