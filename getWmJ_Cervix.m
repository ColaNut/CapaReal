function [ BkTet, cFlag ] = getWmJ_Cervix( P1_Crdt, P2_Crdt, P3_Crdt, P4_Crdt, ...
...
if ( P1_flag == 1 && P2_flag == 1 && P3_flag == 1 ) || ( P1_flag == 3 && P2_flag == 3 && P3_flag == 3 )
...
elseif ( P1_flag == 1 && P2_flag == 1 && P4_flag == 1 ) || ( P1_flag == 3 && P2_flag == 3 && P4_flag == 3 ) 
    if mainEdge == 1 || mainEdge == 3 || mainEdge == 5 
        ...
        if P1_flag == 1 && P2_flag == 1 && P4_flag == 1
            J = J_0 * [ - z, 0, x ] / norm( [ - z, 0, x ] );
        else
            J = J_0 * [ z, 0, - x ] / norm( [ z, 0, - x ] );
        end
...
elseif ( P1_flag == 1 && P3_flag == 1 && P4_flag == 1 ) || ( P1_flag == 3 && P3_flag == 3 && P4_flag == 3 )
    if mainEdge == 2 || mainEdge == 3 || mainEdge == 6 
        ...
        if P1_flag == 1 && P3_flag == 1 && P4_flag == 1
            J = J_0 * [ - z, 0, x ] / norm( [ - z, 0, x ] );
        else
            J = J_0 * [ z, 0, - x ] / norm( [ z, 0, - x ] );
        end
...
elseif ( P2_flag == 1 && P3_flag == 1 && P4_flag == 1 ) || ( P2_flag == 3 && P3_flag == 3 && P4_flag == 3 )
    if mainEdge == 4 || mainEdge == 5 || mainEdge == 6 
        ...
        if P2_flag == 1 && P3_flag == 1 && P4_flag == 1
            J = J_0 * [ - z, 0, x ] / norm( [ - z, 0, x ] );
        else
            J = J_0 * [ z, 0, - x ] / norm( [ z, 0, - x ] );
        end
