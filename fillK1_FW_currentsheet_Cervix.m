function [ K1_6, B_k_Pnt ] = fillK1_FW_currentsheet_Cervix( vIdx1, vIdx2, vIdx3, vIdx4, v1Table, v2Table, v3Table, v4Table, Vrtx_bndry, J_0, ...
    ...
    cFlag = false;
    [ Bk_val, cFlag ] = getWmJ_Cervix( P1_Crdt, P2_Crdt, P3_Crdt, P4_Crdt, ...
