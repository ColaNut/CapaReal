...
if flag_XZ == 1
    ...
    SARsegXZ = zeros( x_idx_max_B, z_idx_max_B, 6, 8 );
    ...
    for vIdx_B = 1: 1: x_max_vertex_B * z_max_vertex_B
        ...
        if m_v_B >= 2 && m_v_B <= x_max_vertex_B - 1 && ell_v_B >= 2 && ell_v_B <= z_max_vertex_B - 1 
            IntrpltPnts(m_v_B, ell_v_B) = ExecIntrplt( m_v_B, ell_v_B, SARsegXZ, TtrVol, 'XZ' );
        end
    end
    toc;
    ...
    for idx = 1: 1: x_idx_max_B * z_idx_max_B
        ...
        if m_B >= 2 && m_B <= x_idx_max_B - 1 && ell_B >= 2 && ell_B <= z_idx_max_B - 1
            ...
            PntMidPnts9Crdnt(:, 2) = [];
            plotSAR_Intrplt( squeeze( SARsegXZ( m_B, ell_B, :, :) ), squeeze( TtrVol( m_B, ell_B, :, : ) ), ...
...
if flag_XY == 1
    ...
    % calculate the E field
    SARsegXY = zeros( x_idx_max_B, y_idx_max_B, 6, 8 );
    ...
    for idx = 1: 1: x_idx_max_B * y_idx_max_B
        ...
        if m_B >= 2 && m_B <= x_idx_max_B - 1 && n_B >= 2 && n_B <= y_idx_max_B - 1 
            ...
            [ SARsegXY( m_B, n_B, :, : ), TtrVol( m_B, n_B, :, : ), MidPnts9Crdnt( m_B, n_B, :, : ) ] ...
    ...
    for vIdx_B = 1: 1: x_max_vertex_B * y_max_vertex_B
        ...
        if m_v_B >= 2 && m_v_B <= x_max_vertex_B - 1 && n_v_B >= 2 && n_v_B <= y_max_vertex_B - 1 
            IntrpltPnts(m_v_B, n_v_B) = ExecIntrplt( m_v_B, n_v_B, SARsegXY, TtrVol, 'XY' );
        end
    end
    toc;
    ...
    for idx = 1: 1: x_idx_max_B * y_idx_max_B
        ...
        if m_B >= 2 && m_B <= x_idx_max_B - 1 && n_B >= 2 && n_B <= y_idx_max_B - 1
            ...
            PntMidPnts9Crdnt(:, 3) = [];
            plotSAR_Intrplt( squeeze( SARsegXY( m_B, n_B, :, :) ), squeeze( TtrVol( m_B, n_B, :, : ) ), ...
...
if flag_YZ == 1
    ...
    % === === % ============ % === === %
    % calculate the E field
    SARsegYZ = zeros( y_idx_max_B, z_idx_max_B, 6, 8 );
    ...
    for vIdx_B = 1: 1: y_max_vertex_B * z_max_vertex_B
        ...
        if n_v_B >= 2 && n_v_B <= y_max_vertex_B - 1 && ell_v_B >= 2 && ell_v_B <= z_max_vertex_B - 1 
            IntrpltPnts(n_v_B, ell_v_B) = ExecIntrplt( n_v_B, ell_v_B, SARsegYZ, TtrVol, 'YZ' );
        end
    end
    toc;
    ...
    for idx = 1: 1: y_idx_max_B * z_idx_max_B
        ...
        if n_B >= 2 && n_B <= y_idx_max_B - 1 && ell_B >= 2 && ell_B <= z_idx_max_B - 1
            ...
            PntMidPnts9Crdnt(:, 1) = [];
            plotSAR_Intrplt( squeeze( SARsegYZ( n_B, ell_B, :, :) ), squeeze( TtrVol( n_B, ell_B, :, : ) ), ...
