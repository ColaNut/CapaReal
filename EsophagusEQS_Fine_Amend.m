...
% update the shiftedCoordinateXYZ_B for the lumen surrounding four point
for y_idx_B = 1: 1: ( w_y_B + dy ) / dy_B + 1
    shiftedCoordinateXYZ_B(13, y_idx_B, 13, :) = squeeze(shiftedCoordinateXYZ_B(12, y_idx_B, 12, :)) + [  dx_B / sqrt(2), 0,   dz_B / sqrt(2)]';
    shiftedCoordinateXYZ_B(13, y_idx_B, 11, :) = squeeze(shiftedCoordinateXYZ_B(12, y_idx_B, 12, :)) + [  dx_B / sqrt(2), 0, - dz_B / sqrt(2)]';
    shiftedCoordinateXYZ_B(11, y_idx_B, 11, :) = squeeze(shiftedCoordinateXYZ_B(12, y_idx_B, 12, :)) + [- dx_B / sqrt(2), 0, - dz_B / sqrt(2)]';
    shiftedCoordinateXYZ_B(11, y_idx_B, 13, :) = squeeze(shiftedCoordinateXYZ_B(12, y_idx_B, 12, :)) + [- dx_B / sqrt(2), 0,   dz_B / sqrt(2)]';
end
...
save('1023EsoEQS_preElectrode.mat');
% return;
...
DwnElctrdPos = 91;
ElectrodeMask( 22: 24, 24 ) = DwnElctrdPos;
ElectrodeMask( 21, 25 ) = DwnElctrdPos;
ElectrodeMask( 25, 25 ) = DwnElctrdPos;
...
% modification from V_0 = 15 to V_0 = 12
