...
% % clc; clear;
% % digits;
% % disp('EQS, liver, modification of electrode positions');
...
% % epsilon_r_pre = [   1, 113.0,    113,       338,   338 ]';
% % sigma         = [   0,  0.61,   0.61,      0.42,  0.42 ]';
% % epsilon_r     = epsilon_r_pre - i * sigma ./ ( Omega_0 * Epsilon_0 );
...
% % disp('Filling SegMed: ');
% % tic;
% % parfor idx = 1: 1: x_idx_max * y_idx_max * z_idx_max
