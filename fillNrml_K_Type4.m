function varargout = fillNrml_K_Type4( m_v, n_v, ell_v, flag, Vertex_Crdnt, x_max_vertex, y_max_vertex, ...
    ...
    if nVarargs == 3
        K_row_2(:, 1: 13) = repmat(K1_row_2(1: 13), 3, 1);
        [ K_row_2(:, 14: 26), B_k_row2 ] = CurrentType4( FaceCrdnt, squeeze( PntsCrdnt(2, 2, :) ), ...
                                    Side_Cflags, Pnts_Cflags(2, 2), tmpSegMed, J_0, mu_r, '2', quadrantNum );
    end
    ...
    if nVarargs == 3 || nVarargs == 4
        if strcmp(tiltType, 'Horizental')
            if quadrantNum == 2 || quadrantNum == 1 || ( nVarargs == 4 && quadrantNum == 4 ) || ( nVarargs == 4 && quadrantNum == 3 )
                ...
                [ K_row_4(:, 14: 26), B_k_row4 ] = CurrentType4( FaceCrdnt, squeeze( PntsCrdnt(2, 1, :) ), ...
                                        Side_Cflags, Pnts_Cflags(2, 1), tmpSegMed, J_0, mu_r, '4', quadrantNum );
    ...
    if nVarargs == 3 || nVarargs == 4
        if strcmp(tiltType, 'Vertical')
            if quadrantNum == 2 || ( nVarargs == 4 && quadrantNum == 1 ) || ( nVarargs == 4 && quadrantNum == 4 ) || quadrantNum == 3
                ...
                [ K_row_5(:, 14: 26), B_k_row5 ] = CurrentType4( FaceCrdnt, squeeze( PntsCrdnt(1, 5, :) ), ...
                                        Side_Cflags, Pnts_Cflags(1, 5), tmpSegMed, J_0, mu_r, '5', quadrantNum );
    ...
    if nVarargs == 4
        if strcmp(tiltType, 'Oblique') 
            if quadrantNum == 1 || quadrantNum == 3
                ...
                [ K_row_7(:, 20: 38), B_k_row7 ] = CurrentType4( squeeze(FaceCrdnt), squeeze( PntsCrdnt(1, 5, :) ), ...
                                        Side_Cflags, Pnts_Cflags(1, 5), tmpSegMed, J_0, mu_r, '7', quadrantNum );
            end
        end
    end
