...
% % clc; clear;
% % load('0831LungMQSNoMuPrmPrm.mat');

% %               % [ air, bolus, muscle, lung,   tumor,  bone,   fat ]';
% % mu_prime      = [   1,     1,      1,     1,      1,     1,     1 ]';
% % mu_db_prime   = [   0,     0,      0,     0, 0.1133,     0,     0 ]';
% % % mu_db_prime   = [ 0,    0.62 ]';
% % mu_r          = mu_prime - i * mu_db_prime;
...
% % BioFlag = true(N_v, 1);
% % J_0 = 5000; % surface current density: 5000 (A/m) at 8 MHz
...
% % save('0901LungMQS_postK1_MuPrmPrmMod.mat', 'm_K1', 'mu_r');
...
% % load('0901LungMQS_postK1_MuPrmPrmMod.mat', 'm_K1', 'mu_r');
