...
J_0 = 1000; % surface current density: 400 (A/m) at 1.2 MHz
...
save('1013EsoMQS_K_Part1.mat', 'm_K1');
return;
...
load('1013EsoMQS_K_Part1.mat', 'm_K1');
...
load('1013EsoMQS_K_Part2.mat', 'm_K1');
