function [ S1_row ] = fillNrml_S1( m, n, ell, flag, Vertex_Crdnt, x_max_vertex, y_max_vertex, ...
    ...
    switch flag
        ...
        case { '110', '001' }
            ...
            % p1
            LidsValue(1, :) = calS1_mn( squeeze( PntsCrdnt(2, :, :) ), squeeze( PntsCrdnt(1, 5, :) ), PntSegMed(1, :), epsilon_r, 'z_shift' ); 
            % p3
            tmpMidLyr = p3FaceMidLyr( PntsCrdnt );
            LidsValue(2, :) = calS1_mn( tmpMidLyr, squeeze( PntsCrdnt(3, 5, :) ), PntSegMed(2, :), epsilon_r, 'z_shift' ); 
        ...
        case { '100', '011' }
            ...
            LidsValue(1, :) = calS1_mn( tmpMidLyr, squeeze( PntsCrdnt(2, 4, :) ), PntSegMed(1, :), epsilon_r, 'x_shift' ); 
            % p2
            tmpMidLyr = p2FaceMidLyr( PntsCrdnt );
            LidsValue(2, :) = calS1_mn( tmpMidLyr, squeeze( PntsCrdnt(2, 6, :) ), PntSegMed(2, :), epsilon_r, 'x_shift' ); 
        ...
        case { '101', '010' }
            ...
            LidsValue(1, :) = calS1_mn( tmpMidLyr, squeeze( PntsCrdnt(2, 2, :) ), PntSegMed(1, :), epsilon_r, 'x_shift' ); 
            % p2
            tmpMidLyr = p6FaceMidLyr( PntsCrdnt );
            LidsValue(2, :) = calS1_mn( tmpMidLyr, squeeze( PntsCrdnt(2, 8, :) ), PntSegMed(2, :), epsilon_r, 'x_shift' ); 
