function [ K1_row_1, K1_row_2, K1_row_3, K1_row_4, K1_row_5, ...
    ...
    % K_1 [000, 1], [111, 1] 
    K1_row_1(26: 50) = calK1_Type1( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(2, 5, :) ), PntSegMed(2, :), mu_r, '1' );
    ...
    K1_row_2(26: 50) = calK1_Type1( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(2, 5, :) ), PntSegMed(6, :), mu_r, '2' );
    ...
    K1_row_3(26: 50) = calK1_Type1( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(2, 5, :) ), PntSegMed(3, :), mu_r, '3' );
    ...
    K1_row_4(14: 26) = calK1_Type1( squeeze(FaceCrdnt), squeeze( PntsCrdnt(2, 5, :) ), tmpSegMed, mu_r, '4' );
    ...
    K1_row_5(14: 26) = calK1_Type1( squeeze(FaceCrdnt), squeeze( PntsCrdnt(2, 5, :) ), tmpSegMed, mu_r, '5' );
    ...
    K1_row_6(14: 26) = calK1_Type1( squeeze(FaceCrdnt), squeeze( PntsCrdnt(2, 5, :) ), tmpSegMed, mu_r, '6' );
    ...
    K1_row_7(20: 38) = calK1_Type1( squeeze(FaceCrdnt), squeeze( PntsCrdnt(2, 5, :) ), tmpSegMed, mu_r, '7' );
