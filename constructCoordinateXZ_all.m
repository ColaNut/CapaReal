function [ GridShiftTableXZ, shiftedCoordinateXZ ] = constructCoordinateXZ_all( paras2d, dx, dz )
...
air_x = paras2d(1);
air_z = paras2d(2);
GridShiftTableXZ = constructGridShiftTableXZ_all( x_grid_table, z_grid_table, air_x, air_z, dx, dz );
