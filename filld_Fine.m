function Pnt_d = filld_Fine( p1234, N_v, Pnt_d, ...
    ...
    P3_flag = 0;
    P4_flag = 0;
    P1_flag = v2Crdnt(p1234(1), N_v, x_max_vertex, y_max_vertex, z_max_vertex, ... 
                                x_max_vertex_B, y_max_vertex_B, z_max_vertex_B, BndryTable, BndryTable_B, ...
                                m_v_Lft, n_v_Near, ell_v_Dwn, m_v_Rght, n_v_Far, ell_v_Top );
    P2_flag = v2Crdnt(p1234(2), N_v, x_max_vertex, y_max_vertex, z_max_vertex, ... 
                                x_max_vertex_B, y_max_vertex_B, z_max_vertex_B, BndryTable, BndryTable_B, ...
                                m_v_Lft, n_v_Near, ell_v_Dwn, m_v_Rght, n_v_Far, ell_v_Top );
    P3_flag = v2Crdnt(p1234(3), N_v, x_max_vertex, y_max_vertex, z_max_vertex, ... 
                                x_max_vertex_B, y_max_vertex_B, z_max_vertex_B, BndryTable, BndryTable_B, ...
                                m_v_Lft, n_v_Near, ell_v_Dwn, m_v_Rght, n_v_Far, ell_v_Top );
    P4_flag = v2Crdnt(p1234(4), N_v, x_max_vertex, y_max_vertex, z_max_vertex, ... 
                                x_max_vertex_B, y_max_vertex_B, z_max_vertex_B, BndryTable, BndryTable_B, ...
                                m_v_Lft, n_v_Near, ell_v_Dwn, m_v_Rght, n_v_Far, ell_v_Top );
