...
% === % ================================== % === %
% === % Fill Up Time of sparseS and SegMed % === %
% === % ================================== % === % 
...
%         % v are un-ordered vertices; while p are ordered vertices.
    ...
    for TetFinder = 1: 1: length(Candi) - 1
        for itr = TetFinder + 1: length(Candi)
            if uG( Candi(TetFinder), Candi(itr) )
                ...
                Counter = [ MedTetTable( tetRow, P1(eIdx) ), MedTetTable( tetRow, P2(eIdx)), ...
                                        MedTetTable( tetRow, Candi(itr) ), MedTetTable( tetRow, Candi(TetFinder) ) ];
                ...
                [ K1_6, B_k_Pnt ] = fillK1_FW_2( P1(eIdx), P2(eIdx), Candi(itr), Candi(TetFinder), Counter, ...
                    G( :, P1(eIdx) ), G( :, P2(eIdx) ), G( :, Candi(itr) ), G( :, Candi(TetFinder) ), ...
