function Extract7 = p463Face_2( Ori27, Text )

switch Text
    case 'Crdnt'
        Extract7 = zeros(1, 7, 3);
        Extract7(1, 1, :) = Ori27(1, 4, :);
        Extract7(1, 2, :) = Ori27(1, 1, :);
        Extract7(1, 3, :) = Ori27(1, 2, :);
        Extract7(1, 4, :) = Ori27(1, 5, :);
        Extract7(1, 5, :) = Ori27(2, 1, :);
        Extract7(1, 6, :) = Ori27(2, 2, :);
        Extract7(1, 7, :) = Ori27(2, 5, :);
    case 'Med'
        Extract7 = zeros(7, 1);
        Extract7(1) = Ori27(1, 4);
        Extract7(2) = Ori27(1, 1);
        Extract7(3) = Ori27(1, 2);
        Extract7(4) = Ori27(1, 5);
        Extract7(5) = Ori27(2, 1);
        Extract7(6) = Ori27(2, 2);
