function [ sparseS_1, B_phi ] = PutOnDwnElctrd_Esophagus_Fine( sparseS_1, B_phi, N_v, V_0, DwnElctrdMask, DwnElctrdPos, x_max_vertex_B, y_max_vertex_B, z_max_vertex_B, w_x_B, w_y_B, w_z_B, dx_B, dy_B, dz_B )
