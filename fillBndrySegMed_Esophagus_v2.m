function SegMed = fillBndrySegMed_Esophagus_v2( m, n, ell, shiftedCoordinateXYZ, x_idx_max, y_idx_max, z_idx_max, ...
    ...
    % elseif PntsMed(3, 5) == EsBndryNum
        SegMed(1, :) = fillSideBndrySegMed_Esophagus_v2( squeeze( MidPntsCrdnt(3, :, :) ), ...
                        squeeze( PntsCrdnt(2, 5, :) )', PntsMed(3, 5), PntsMed(2, 5), SegMed(1, :) );
    % end
    ...
    % elseif PntsMed(2, 4) == EsBndryNum
        SegMed(2, :) = fillSideBndrySegMed_Esophagus_v2( squeeze( tmpMidCrdnt ), ...
                        squeeze( PntsCrdnt(2, 5, :) )', PntsMed(2, 4), PntsMed(2, 5), SegMed(2, :) );
    % end

% td-do: check p3, p5 and p6 for the feed in of coordinate.
    % p3
    ...
    % elseif PntsMed(1, 5) == EsBndryNum
        ...
        SegMed(3, :) = fillSideBndrySegMed_Esophagus_v2( squeeze( tmpMidCrdnt ), ...
                        squeeze( PntsCrdnt(2, 5, :) )', PntsMed(1, 5), PntsMed(2, 5), SegMed(3, :) );
    % end
    ...
    % elseif PntsMed(2, 6) == EsBndryNum
        ...
        SegMed(4, :) = fillSideBndrySegMed_Esophagus_v2( squeeze( tmpMidCrdnt ), ...
                        squeeze( PntsCrdnt(2, 5, :) )', PntsMed(2, 6), PntsMed(2, 5), SegMed(4, :) );
    % end
    ...
    % elseif PntsMed(2, 8) == EsBndryNum
        ...
        SegMed(5, :) = fillSideBndrySegMed_Esophagus_v2( squeeze( tmpMidCrdnt ), ...
    ...
    % elseif PntsMed(2, 2) == EsBndryNum
        ...
        SegMed(6, :) = fillSideBndrySegMed_Esophagus_v2( squeeze( tmpMidCrdnt ), ...
