...
digits;
disp('Lung EQS');
disp('Right above tumor, the dielectric properties of a strip of muscle-adipose tissue interface, is modified.');
disp('Case 1 : ');
disp('Adippose tissue: un-modified');
disp('Adipose-muscle interface: conductiviy by 2.5 times');
...
rho           = [   1,  1020,   1020,  394,  697,  1790,   900, 1020 ]';
% epsilon_r_pre = [ 1, 113.0,   184, 264.9,  402,    7.3]';
% sigma         = [ 0,  0.61, 0.685,  0.42, 0.68, 0.028 ]';
epsilon_r_pre = [   1,   172,   172, 264.9,   402,    39,   13.7, 172 ]';
% sigma         = [   0,  0.69,  0.69,  0.42,  0.68, 0.045, 0.0245 ]';
sigma         = [   0,  0.69,  0.69,  0.42,  0.68, 0.045, 0.0245, 0.69 * 2.5 ]';
