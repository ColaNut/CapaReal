...
disp('Reduced fat of only upper region');
disp('Re-simulate case 3');
disp('Try with no reduction of adipose tissue, but with both upper and lower adipose tissue effected');
