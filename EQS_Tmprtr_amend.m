...
fname = 'D:\Kevin\CapaReal\0715';
% load( strcat(fname, 'Tmprtr2cm0717Report.mat'), 'm_U', 'm_V' );
...
load( strcat(fname, '\m_U_m_V_', tmprtrName, '.mat'), 'm_U', 'm_V' );
% load( strcat(fname, '\Tmprtr2cm0717Report.mat'), 'm_U', 'm_V' );
...
save('0810_twoFoldPower.mat', 'bar_b');
% saveas(figure(4), 'lowerTumorXi.jpg');
