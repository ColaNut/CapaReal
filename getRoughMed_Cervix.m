function [ mediumTableXZ ] = getRoughMed_Cervix( mediumTableXZ, paras2dXZ, dx, dz, varargin )
...
mediumTableXZ = medFill( mediumTableXZ, 0, 0, bolus_a, bolus_c, dx, dz, 4, air_x, air_z );
...
if nVarargs == 1
    ...
    mediumTableXZ = medFill( mediumTableXZ, 0, 0, muscle_a, muscle_c, dx, dz, 2, air_x, air_z );
    mediumTableXZ = medFill( mediumTableXZ, 0, 0, fat_a, fat_c, dx, dz, 1, air_x, air_z );
end
