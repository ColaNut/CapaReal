...
% % === === % ======================= % === === %
% load('0920EsoEQS.mat', 'MedTetTableCell');
% % tic;
...
% amending code for mu'' in esophageal cancer.
load('0920EsoMQS_K1_Amend.mat', 'm_K1');
...
% === === % =========== % === === %
bar_x_my_gmres1 = bar_x_my_gmres;
muPrmPrm_MNP = mu_db_prime(EsNum);
