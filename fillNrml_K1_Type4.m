function [ K1_row_1, K1_row_2, K1_row_3, K1_row_4, K1_row_5, ...
    ...
    K1_row_1(14: 26) = calK1_mn( FaceCrdnt, squeeze( PntsCrdnt(2, 4, :) ), tmpSegMed, mu_r, 'fourTet' );
    B_k( K1_row_1(13) ) = calBk_m( FaceCrdnt, squeeze( PntsCrdnt(2, 4, :) ), ...
                                    Side_Cflags, Pnts_Cflags(2, 4), J_0, 'fourTet' );
    ...
    K1_row_2(14: 26) = calK1_mn( FaceCrdnt, squeeze( PntsCrdnt(2, 2, :) ), tmpSegMed, mu_r, 'fourTet' );
    B_k( K1_row_2(13) ) = calBk_m( FaceCrdnt, squeeze( PntsCrdnt(2, 2, :) ), ...
    ...
    % K_1 [000, 1], [111, 1] 
    K1_row_3(26: 50) = calK1_mn( squeeze(FaceCrdnt), squeeze( PntsCrdnt(1, 5, :) ), PntSegMed(1, :), mu_r, 'eightTet' );
    B_k( K1_row_3(25) ) = calBk_m( squeeze(FaceCrdnt), squeeze( PntsCrdnt(1, 5, :) ), ...
                                    Side_Cflags, Pnts_Cflags(1, 5), J_0, 'eightTet' );
    ...
    K1_row_4(14: 26) = calK1_mn( FaceCrdnt, squeeze( PntsCrdnt(2, 1, :) ), tmpSegMed, mu_r, 'fourTet' );
    B_k( K1_row_4(13) ) = calBk_m( FaceCrdnt, squeeze( PntsCrdnt(2, 1, :) ), ...
                                    Side_Cflags, Pnts_Cflags(2, 1), J_0, 'fourTet' );
    ...
    K1_row_5(14: 26) = calK1_mn( FaceCrdnt, squeeze( PntsCrdnt(1, 5, :) ), tmpSegMed, mu_r, 'fourTet' );
    B_k( K1_row_5(13) ) = calBk_m( FaceCrdnt, squeeze( PntsCrdnt(1, 5, :) ), ...
                                    Side_Cflags, Pnts_Cflags(1, 5), J_0, 'fourTet' );
    ...
    K1_row_6(14: 26) = calK1_mn( FaceCrdnt, squeeze( PntsCrdnt(1, 5, :) ), tmpSegMed, mu_r, 'fourTet' );
    B_k( K1_row_6(13) ) = calBk_m( FaceCrdnt, squeeze( PntsCrdnt(1, 5, :) ), ...
                                    Side_Cflags, Pnts_Cflags(1, 5), J_0, 'fourTet' );
    ...
    K1_row_7(20: 38) = calK1_mn( squeeze(FaceCrdnt), squeeze( PntsCrdnt(1, 5, :) ), tmpSegMed, mu_r, 'sixTet' );
    B_k( K1_row_7(19) ) = calBk_m( squeeze(FaceCrdnt), squeeze( PntsCrdnt(1, 5, :) ), ...
                                    Side_Cflags, Pnts_Cflags(1, 5), J_0, 'sixTet' );
