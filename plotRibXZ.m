...
%            sternum_hx, sternum_hz, sternum_wy, sternum_x, sternum_z ];
    ...
    plot(L_InnX(L_InnIdx), L_InnZ(L_InnIdx), 'Color', [0, 0, 0], 'LineWidth', 3.0);
    ...
    plot(L_ExtX(L_ExtIdx), L_ExtZ(L_ExtIdx), 'Color', [0, 0, 0], 'LineWidth', 3.0);

    t2 = linspace( pi, 3 * pi, 400 );
    R_InnX = r_rib_x + rib_rad * cos(t2);
    R_InnZ = r_rib_z + rib_rad * sin(t2);
    R_InnIdx = find( R_InnX >= h_x_sp / 2 );
    plot(R_InnX(R_InnIdx), R_InnZ(R_InnIdx), 'Color', [0, 0, 0], 'LineWidth', 3.0);
    ...
    plot(R_ExtX(R_ExtIdx), R_ExtZ(R_ExtIdx), 'Color', [0, 0, 0], 'LineWidth', 3.0);
    ...
    plot(RunningIdx, SpineTop, 'Color', [0, 0, 0], 'LineWidth', 3.0);
    plot(RunningIdx, SpineDwn, 'Color', [0, 0, 0], 'LineWidth', 3.0);
    ...
    plot(SpineLft, RunningIdx, 'Color', [0, 0, 0], 'LineWidth', 3.0);
    plot(SpineRght, RunningIdx, 'Color', [0, 0, 0], 'LineWidth', 3.0);
    ...
    plot(RunningIdx, StTop, 'Color', [0, 0, 0], 'LineWidth', 3.0);
    plot(RunningIdx, StDwn, 'Color', [0, 0, 0], 'LineWidth', 3.0);
    ...
    plot(StLft, RunningIdx, 'Color', [0, 0, 0], 'LineWidth', 3.0);
    plot(StRght, RunningIdx, 'Color', [0, 0, 0], 'LineWidth', 3.0);
