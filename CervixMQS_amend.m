...
% Vrtx_bndry(23, n_near_v1: n_far_v1, 25) = 1;    Vrtx_bndry(23, n_near_v3: n_far_v3, 5) = 3;
% Vrtx_bndry(24, n_near_v1: n_far_v1, 26) = 1;    Vrtx_bndry(24, n_near_v3: n_far_v3, 6) = 3;
% Vrtx_bndry(25, n_near_v1: n_far_v1, 27) = 1;    Vrtx_bndry(25, n_near_v3: n_far_v3, 7) = 3;
% Vrtx_bndry(26, n_near_v1: n_far_v1, 26) = 1;    Vrtx_bndry(26, n_near_v3: n_far_v3, 6) = 3;
% Vrtx_bndry(27, n_near_v1: n_far_v1, 25) = 1;    Vrtx_bndry(27, n_near_v3: n_far_v3, 5) = 3;
% Vrtx_bndry(26, n_near_v1: n_far_v1, 24) = 1;    Vrtx_bndry(26, n_near_v3: n_far_v3, 4) = 3;
% Vrtx_bndry(25, n_near_v1: n_far_v1, 23) = 1;    Vrtx_bndry(25, n_near_v3: n_far_v3, 3) = 3;
% Vrtx_bndry(24, n_near_v1: n_far_v1, 24) = 1;    Vrtx_bndry(24, n_near_v3: n_far_v3, 4) = 3;
...
switch PartNum
    case 1
        Rng = [ 1, ceil(l_G / 2) ];
    case 2
        Rng = [ ceil(l_G / 2) + 1, l_G ];
    % case 3
    %     Rng = [ ceil(2 * l_G / 8) + 1, ceil(3 * l_G / 8) ];
    % case 4
    %     Rng = [ ceil(3 * l_G / 8) + 1, ceil(4 * l_G / 8) ];
    % case 5
    %     Rng = [ ceil(4 * l_G / 8) + 1, ceil(5 * l_G / 8) ];
    % case 6
    %     Rng = [ ceil(5 * l_G / 8) + 1, ceil(6 * l_G / 8) ];
    % case 7
    %     Rng = [ ceil(6 * l_G / 8) + 1, ceil(7 * l_G / 8) ];
    % case 8
    %     Rng = [ ceil(7 * l_G / 8) + 1, ceil(    l_G    ) ];
    otherwise
        error('check');
end
...
save( strcat('0906MQS_postK', num2str(PartNum), '.mat' ), 'm_K1', 'B_k' );
