function [ K1_Value, J ] = CurrentType4( SideCrdnt, CntrlCrdnt, Side_Cflag, Cntrl_Cflag, SegMed, J_0, mu_r, SideIdx )
% Cflag -> current flag
...
switch SideIdx
    ...
    case '2'
        ...
        % FourTet_e(2, :, :) = calBC( SideCrdnt(2, :), SideCrdnt(5, :), SideCrdnt(3, :), CntrlCrdnt', ...
    ...
    case '5'
        ...
        % FourTet_e(2, :, :) = calBC( SideCrdnt(5, :), SideCrdnt(2, :), CntrlCrdnt', SideCrdnt(3, :), ...
    ...
    case '7'
        ...
        % K_1: the 1-st to the 8-th tetdrahedron
        SixTet_e(1, :, :) = calBC( SideCrdnt(7, :), CntrlCrdnt', SideCrdnt(4, :), SideCrdnt(3, :), ...
                                Side_Cflag(7), Cntrl_Cflag, Side_Cflag(4), Side_Cflag(3), 5, 'ext', J_0 );
        SixTet_e(2, :, :) = calBC( SideCrdnt(7, :), CntrlCrdnt', SideCrdnt(6, :), SideCrdnt(3, :), ...
                                Side_Cflag(7), Cntrl_Cflag, Side_Cflag(6), Side_Cflag(3), 5, 'inn', J_0 );
        SixTet_e(3, :, :) = calBC( CntrlCrdnt', SideCrdnt(6, :), SideCrdnt(5, :), SideCrdnt(3, :), ...
                                Cntrl_Cflag, Side_Cflag(6), Side_Cflag(5), Side_Cflag(3), 3, 'ext', J_0 );
        SixTet_e(4, :, :) = calBC( CntrlCrdnt', SideCrdnt(5, :), SideCrdnt(3, :), SideCrdnt(2, :), ...
                                Cntrl_Cflag, Side_Cflag(5), Side_Cflag(3), Side_Cflag(2), 2, 'inn', J_0 );
        SixTet_e(5, :, :) = calBC( CntrlCrdnt', SideCrdnt(1, :), SideCrdnt(3, :), SideCrdnt(2, :), ...
                                Cntrl_Cflag, Side_Cflag(1), Side_Cflag(3), Side_Cflag(2), 2, 'ext', J_0 );
        SixTet_e(6, :, :) = calBC( CntrlCrdnt', SideCrdnt(4, :), SideCrdnt(1, :), SideCrdnt(3, :), ...
