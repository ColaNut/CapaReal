function plotXY_EsoEQS1017( paras2dXY, dx, dy )
...
plot( x_tumor_far, ( 0 + tumor_hy_es / 2 ) * ones( size(x_tumor_far) ), 'Color', [0, 0, 0], 'LineWidth', 2.5);
plot( x_tumor_far, ( 0 - tumor_hy_es / 2 ) * ones( size(x_tumor_far) ), 'Color', [0, 0, 0], 'LineWidth', 2.5);

% plot vertical coil
y_idx_coil = tumor_y_es - tumor_hy_es / 2: dy / 10: tumor_y_es + tumor_hy_es / 2;
