...
% rho           = [ 1,  1020,  1020,  1050, 1040 ]';
              % [ air, bolus, muscle, cervical tumor,  tumor,  bone,   fat ]';
rho           = [   1,  1020,   1020,           1020,  697,  1790,   900 ]';
% epsilon_r_pre = [ 1, 113.0,   184, 264.9,  402,    7.3]';
% sigma         = [ 0,  0.61, 0.685,  0.42, 0.68, 0.028 ]';
epsilon_r_pre = [   1, 113.0,    113,             386,   402,   7.3,    20 ]';
sigma         = [   0,  0.61,   0.61,           0.614,  0.68, 0.028, 0.047 ]';
