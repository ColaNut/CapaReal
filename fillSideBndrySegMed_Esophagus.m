function SegMed = fillSideBndrySegMed_Esophagus( Side9Pnts, CtrlPnt, SidePntFlag, CtrlPntFlag, SegMed )
...
% SegMed      = ones(1, 8, 'uint8');
    ...
    for idx = 1: 1: 8
        SegMed(idx) = getTetMed_Esophagus( TtrCrdnt(idx, :), CtrlPntFlag, SegMed(idx) );
    end
