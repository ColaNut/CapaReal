function mediumTableXZ = getRoughMed_Eso_B_1008( mediumTableXZ, y_idx, w_x_B, w_y_B, w_z_B, dx_B, dy_B, dz_B )
...
tumor_y_idx_near = (tumor_y_es - tumor_hy_es / 2) / dy_B + w_y_B / (2 * dy_B) + 1;
