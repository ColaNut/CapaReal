function varargout = fillNrml_K_Type3( m_v, n_v, ell_v, flag, Vertex_Crdnt, x_max_vertex, y_max_vertex, ...
    ...
    KEV_row_1(1) = PntsIdx(1, 4);
    KEV_row_1(2) = PntsIdx(2, 8);
    KEV_row_1(3) = PntsIdx(2, 4);
    KEV_row_1(4) = PntsIdx(2, 2);
    KEV_row_1(5) = PntsIdx(3, 4);
    KEV_row_1(6) = PntsIdx(2, 5);
    ...
    Side_Cflags(2) = Pnts_Cflags(2, 8);
    Side_Cflags(3) = Pnts_Cflags(2, 4);
    Side_Cflags(4) = Pnts_Cflags(2, 2);
    Side_Cflags(5) = Pnts_Cflags(3, 4);
    % FaceCrdnt = p4FaceMidLyr( PntsCrdnt );
    tmpSegMed = [ PntSegMed(1, 1), PntSegMed(2, 4), PntSegMed(2, 5), PntSegMed(1, 8) ];
    [ K1_row_1(14: 26), KEV_row_1(7: 12), KVE_col_1(7: 12) ] = calK_Type3( FaceCrdnt, squeeze( PntsCrdnt(2, 5, :) ), tmpSegMed, mu_r, epsilon_r, corner_flag, '1' );
    B_k( K1_row_1(13) ) = calBk_Type3( FaceCrdnt, squeeze( PntsCrdnt(2, 5, :) ), ...
                                    Side_Cflags, Pnts_Cflags(2, 5), J_0, '1' );
    % if edgeTable( K1_row_1(13) )
    %     [ K1_row_1(:, 14: 26), B_k( K1_row_1(13) ) ] = CurrentType3_Prm( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(2, 5, :) ), ...
    %                                 Side_Cflags, Pnts_Cflags(2, 5), tmpSegMed, J_0, mu_r, '1' );
    % end
    ...
    % p1
    KEV_row_2(1: 9) = p5Face_Type3( PntsIdx, 'Med' )';
    KEV_row_2(10) = PntsIdx(2, 2);
    ...
    FaceCrdnt = p5Face_Type3( PntsCrdnt, 'Crdnt' );
    ...
    if nVarargs == 3
        ...
        [ K_row_2(:, 26: 50), B_k_row2 ] = CurrentType3( squeeze(FaceCrdnt), squeeze( PntsCrdnt(2, 2, :) ), ...
                                    Side_Cflags, Pnts_Cflags(2, 2), PntSegMed(1, :), J_0, mu_r, '2', quadrantNum, tiltType );
    end
    ...
    %     [ K1_row_2(:, 26: 50), B_k( K1_row_2(25) ) ] = CurrentType3_Prm( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(2, 2, :) ), ...
    ...
    KEV_row_3(1) = PntsIdx(1, 4);
    KEV_row_3(2) = PntsIdx(2, 2);
    KEV_row_3(3) = PntsIdx(1, 5);
    KEV_row_3(4) = PntsIdx(2, 8);
    KEV_row_3(5) = PntsIdx(1, 6);
    ...
    Side_Cflags = zeros(5, 1, 'uint8');
    Side_Cflags(1) = Pnts_Cflags(1, 4);
    Side_Cflags(2) = Pnts_Cflags(2, 2);
    Side_Cflags(3) = Pnts_Cflags(1, 5);
    Side_Cflags(4) = Pnts_Cflags(2, 8);
    Side_Cflags(5) = Pnts_Cflags(1, 6);
    % FaceCrdnt = p6Face( PntsCrdnt );
    tmpSegMed = [ PntSegMed(2, 7), PntSegMed(1, 6), PntSegMed(1, 7), PntSegMed(2, 6) ];
    [ K1_row_3(14: 26), KEV_row_3(7: 12), KVE_col_3(7: 12) ] = calK_Type3( FaceCrdnt, squeeze( PntsCrdnt(2, 5, :) ), tmpSegMed, mu_r, epsilon_r, corner_flag, '3' );
    B_k( K1_row_3(13) ) = calBk_Type3( FaceCrdnt, squeeze( PntsCrdnt(2, 5, :) ), ...
                                    Side_Cflags, Pnts_Cflags(2, 5), J_0, '3' );
    % if edgeTable( K1_row_3(13) )
    %     [ K1_row_3(:, 14: 26), B_k( K1_row_3(13) ) ] = CurrentType3_Prm( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(2, 5, :) ), ...
    %                                 Side_Cflags, Pnts_Cflags(2, 5), tmpSegMed, J_0, mu_r, '3' );
    % end
    ...
    K1_row_4(9)    = vIdx2eIdx(PntsIdx_prm(2, 2), 1, x_max_vertex, y_max_vertex, z_max_vertex);
    ...
    KEV_row_4(1) = PntsIdx(1, 4);
    KEV_row_4(2) = PntsIdx(2, 5);
    KEV_row_4(3) = PntsIdx(2, 4);
    KEV_row_4(4) = PntsIdx(2, 1);
    KEV_row_4(5) = PntsIdx(3, 4);
    KEV_row_4(6) = PntsIdx(2, 2);
    ...
    if nVarargs == 3 || nVarargs == 4
        if strcmp(tiltType, 'Horizental')
            if quadrantNum == 2 || quadrantNum == 1 || ( nVarargs == 4 && quadrantNum == 3 ) || ( nVarargs == 4 && quadrantNum == 4 )
                K_row_4(:, 1: 13) = repmat(K1_row_4(1: 13), 4, 1);
                [ K_row_4(:, 14: 26), B_k_row4 ] = CurrentType3( FaceCrdnt, squeeze( PntsCrdnt(2, 2, :) ), ...
                                        Side_Cflags, Pnts_Cflags(2, 2), tmpSegMed, J_0, mu_r, '4', quadrantNum );
    ...
    %     [ K1_row_4(:, 14: 26), B_k( K1_row_4(13) ) ] = CurrentType3_Prm( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(2, 2, :) ), ...
    ...
    KEV_row_5(1) = PntsIdx(1, 4);
    KEV_row_5(2) = PntsIdx(1, 2);
    KEV_row_5(3) = PntsIdx(1, 5);
    KEV_row_5(4) = PntsIdx(2, 5);
    KEV_row_5(5) = PntsIdx(1, 6);
    KEV_row_5(6) = PntsIdx(2, 2);
        ...
        if strcmp(tiltType, 'Vertical')
            if quadrantNum == 2 || ( nVarargs == 4 && quadrantNum == 1 ) || ( nVarargs == 4 && quadrantNum == 4 ) || quadrantNum == 3
                ...
                [ K_row_5(:, 14: 26), B_k_row5 ] = CurrentType3( FaceCrdnt, squeeze( PntsCrdnt(2, 2, :) ), ...
                                        Side_Cflags, Pnts_Cflags(2, 2), tmpSegMed, J_0, mu_r, '5', quadrantNum );
    ...
    %     [ K1_row_5(:, 14: 26), B_k( K1_row_5(13) ) ] = CurrentType3_Prm( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(2, 2, :) ), ...
    ...
    KEV_row_6(1) = PntsIdx(2, 2);
    KEV_row_6(2) = PntsIdx(2, 4);
    KEV_row_6(3) = PntsIdx(2, 5);
    KEV_row_6(4) = PntsIdx(1, 5);
    KEV_row_6(5) = PntsIdx(2, 8);
    KEV_row_6(6) = PntsIdx(1, 4);
    ...
    Side_Cflags = zeros(5, 1, 'uint8');
    Side_Cflags(1) = Pnts_Cflags(2, 2);
    Side_Cflags(2) = Pnts_Cflags(2, 4);
    Side_Cflags(3) = Pnts_Cflags(2, 5);
    Side_Cflags(4) = Pnts_Cflags(1, 5);
    Side_Cflags(5) = Pnts_Cflags(2, 8);
    tmpSegMed = [ PntSegMed(2, 6), PntSegMed(2, 5), PntSegMed(1, 8), PntSegMed(1, 7) ];
    [ K1_row_6(14: 26), KEV_row_6(7: 12), KVE_col_6(7: 12) ] = calK_Type3( FaceCrdnt, squeeze( PntsCrdnt(1, 4, :) ), tmpSegMed, mu_r, epsilon_r, corner_flag, '6' );
    B_k( K1_row_6(13) ) = calBk_Type3( FaceCrdnt, squeeze( PntsCrdnt(1, 4, :) ), ...
                                    Side_Cflags, Pnts_Cflags(1, 4), J_0, '6' );
    % if edgeTable( K1_row_6(13) )
    %     [ K1_row_6(:, 14: 26), B_k( K1_row_6(13) ) ] = CurrentType3_Prm( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(1, 4, :) ), ...
    %                                 Side_Cflags, Pnts_Cflags(1, 4), tmpSegMed, J_0, mu_r, '6' );
    % end

    % 7-th edge
    K1_row_7(1)    = vIdx2eIdx(PntsIdx_prm(2, 5), 2, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(2)    = vIdx2eIdx(PntsIdx_prm(2, 5), 1, x_max_vertex, y_max_vertex, z_max_vertex);
    ...
    K1_row_7(5)    = vIdx2eIdx(PntsIdx_prm(2, 2), 1, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(6)    = vIdx2eIdx(PntsIdx_prm(2, 1), 3, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(7)    = vIdx2eIdx(PntsIdx_prm(2, 2), 6, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(8)    = vIdx2eIdx(PntsIdx_prm(1, 2), 1, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(9)    = vIdx2eIdx(PntsIdx_prm(2, 2), 3, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(10)   = vIdx2eIdx(PntsIdx_prm(1, 5), 2, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(11)   = vIdx2eIdx(PntsIdx_prm(2, 5), 5, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(12)   = vIdx2eIdx(PntsIdx_prm(2, 5), 3, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(13)   = vIdx2eIdx(PntsIdx_prm(2, 5), 6, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(14)   = vIdx2eIdx(PntsIdx_prm(2, 4), 3, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(15)   = vIdx2eIdx(PntsIdx_prm(2, 4), 5, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(16)   = vIdx2eIdx(PntsIdx_prm(1, 4), 2, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(17)   = vIdx2eIdx(PntsIdx_prm(1, 5), 4, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(18)   = vIdx2eIdx(PntsIdx_prm(1, 5), 1, x_max_vertex, y_max_vertex, z_max_vertex);
    K1_row_7(19)   = vIdx2eIdx(PntsIdx_prm(2, 5), 7, x_max_vertex, y_max_vertex, z_max_vertex);

    KEV_row_7(1: 7) = p164Face_2( PntsIdx, 'Med' )';
    KEV_row_7(8)    = PntsIdx(1, 4);
    KVE_col_7(1: 8) = KEV_row_7(1: 8)';

    FaceCrdnt = zeros(1, 7, 3);
    FaceCrdnt = p164Face_2( PntsCrdnt, 'Crdnt' );
    Side_Cflags = zeros(7, 1);
    Side_Cflags = p164Face_2( Pnts_Cflags, 'Med' );
    % FaceCrdnt = zeros(7, 3);
        ...
        if strcmp(tiltType, 'Oblique')
            if quadrantNum == 2 || ( nVarargs == 4 && quadrantNum == 4 ) 
                ...
                [ K_row_7(:, 20: 38), B_k_row7 ] = CurrentType3( squeeze(FaceCrdnt), squeeze( PntsCrdnt(1, 4, :) ), ...
                                        Side_Cflags, Pnts_Cflags(1, 4), tmpSegMed, J_0, mu_r, '7', quadrantNum );
            elseif quadrantNum == 1
                [ K_row_7, B_k_row7 ] ...
                = fc( m_v, n_v, ell_v + 1, flagSUB, ...
                    Vertex_Crdnt, x_max_vertex, y_max_vertex, z_max_vertex, SegMedInSUB, auxiSegMedSUB, epsilon_r, mu_r, omega, ...
    ...
    %     [ K1_row_7(:, 20: 38), B_k( K1_row_7(19) ) ] = CurrentType3_Prm( squeeze( FaceCrdnt ), squeeze( PntsCrdnt(1, 4, :) ), ...
