function varargout = fillNrml_K_Type3( m_v, n_v, ell_v, flag, Vertex_Crdnt, x_max_vertex, y_max_vertex, ...
    ...
    if nVarargs == 3
        ...
        [ K_row_2(:, 26: 50), B_k_row2 ] = CurrentType3( squeeze(FaceCrdnt), squeeze( PntsCrdnt(2, 2, :) ), ...
                                    Side_Cflags, Pnts_Cflags(2, 2), PntSegMed(1, :), J_0, mu_r, '2', quadrantNum );
    end
    ...
    if nVarargs == 3 || nVarargs == 4
        if strcmp(tiltType, 'Horizental')
            if quadrantNum == 2 || quadrantNum == 1 || ( nVarargs == 4 && quadrantNum == 3 )
    ...
    if nVarargs == 4
        if strcmp(tiltType, 'Horizental') && quadrantNum == 3 
